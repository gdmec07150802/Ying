...
package com.example.administrator.ying.zxing.camera;
...
import com.example.administrator.ying.zxing.app.PreferencesActivity;
import com.example.administrator.ying.zxing.decode.PlanarYUVLuminanceSource;
...
public final class CameraManager {
	...
	//	Log.i(TAG, "Flash modes: " + flashModes);
		L.i("Flash mode: " + flashMode);
		L.i("Flash modes: " + flashModes);
		// 闪光灯关闭状态
	...
	public void turnLightOff() {
		...
		if (!Parameters.FLASH_MODE_OFF.equals(flashMode)) {
			...
			if (flashModes.contains(Parameters.FLASH_MODE_OFF)) {
				...
				L.e("FLASH_MODE_OFF not supported");
			}
		}
	}
}

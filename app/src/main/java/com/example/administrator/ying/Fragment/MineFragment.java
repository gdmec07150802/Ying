...
import com.example.administrator.ying.entity.MyUser;
import com.example.administrator.ying.ui.LoginActivity;
import com.example.administrator.ying.utils.L;
import com.example.administrator.ying.utils.UtilTools;
import com.example.administrator.ying.view.CustomDialog;
...
public class MineFragment extends BaseFragment implements View.OnClickListener{
    ...
    private void findView(View mContentView) {
        btn_exit_user = (Button) mContentView.findViewById(R.id.btn_exit_user);
        btn_exit_user.setOnClickListener(this);
        edit_user = (TextView) mContentView.findViewById(R.id.edit_user);
        edit_user.setOnClickListener(this);
        btn_update_ok = (Button) mContentView.findViewById(R.id.btn_update_ok);
        btn_update_ok.setOnClickListener(this);
        et_username = (EditText) mContentView.findViewById(R.id.et_username);
        et_sex = (EditText) mContentView.findViewById(R.id.et_sex);
        et_desc = (EditText) mContentView.findViewById(R.id.et_desc);
